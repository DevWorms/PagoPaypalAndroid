package com.salvador.devworms.pagopaypal;
...
public class MainActivity extends Activity {
    ...
    private static final String CONFIG_CLIENT_ID = "tu id client";
    ...
    private PayPalPayment getThingToBuy(String paymentIntent) {
        return new PayPalPayment(new BigDecimal("30.00"), "USD", "Recarga HurryApp",
                paymentIntent);
    }
